...
<Callout type="info">
    For in depth understanding of Triggers go to our [Trigger documentation](/triggers)
</Callout>
...
- **Polling:** Default polling interval of 5 minutes, or 1 minute for Business plan users.

## Workflow Actions

<Callout type="info">
    For in depth understanding of Actions go to our [Action documentation](/actions)
</Callout>
...
<Callout type="info">
    1. **Use Mock Data:** Returns a sample response
    2. **Use Real Data:** Creates a real call to the app integration endpoint and returns the real response.
</Callout>
<Callout type="info">
    Once you have ran **Save & Test**, you can map the response to another action or trigger input.
</Callout>
...
<Callout>
    A node is an action or a trigger in a workflow. When you add a trigger or action to a workflow, you are adding a node.
</Callout>
