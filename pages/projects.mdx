...
<Callout type="info">
  On the **Starter** plan, you can only have one project your workspace. Upgrade
  to the **Professional** or **Team** plans to create multiple projects.
</Callout>

## Workflows

Workflows must be created within a project.

Learn more about workflows at in our [Workflows documentation](/workflows)

## Agents

Agents must be created within a project.
