...
The Lecca.io platform utilizes a credits system to manage various operations, catering to different user needs and subscription plans. Each action performed on the platform consumes a defined number of credits, varying depending on the complexity and resource usage of the task.
...
Our newly introduced Credit Usage page helps users monitor each credit transaction, including project, workflow, agent interactions, and knowledge transactions. This feature assists in improving user awareness and management of their credit consumption.
